              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <section className="mb-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    At Ottopen, we respect your privacy and are committed to protecting your personal data. This Privacy
                    Policy explains how we collect, use, store, and protect your information when you use our literary
                    social networking platform.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    This policy applies to all users of Ottopen, including writers, readers, and literary professionals
                    who create accounts and interact with our platform.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                    <li><strong>Account Information:</strong> Name, username, email address, password</li>
                    <li><strong>Profile Information:</strong> Bio, location, website, writing specialty, profile photo</li>
                    <li><strong>Content:</strong> Posts, comments, messages, literary works, and other content you share</li>
                    <li><strong>Communication:</strong> Messages sent through our platform and support requests</li>
                  </ul>

                  <h3 className="font-semibold text-lg mb-3">Information We Collect Automatically</h3>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                    ...
                    <li><strong>Log Data:</strong> IP address, access times, pages viewed, referring websites</li>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Your profile information, posts, and other content you choose to make public will be visible to
                    other users and may be indexed by search engines.
                  </p>
                ...
                <section className="mb-8">
                  <h2 className="font-serif text-2xl font-semibold mb-4">6. Your Rights and Choices</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <section className="mb-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    ...
                    the purposes outlined in this policy. Specific retention periods depend on the type of information:
                  </p>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                    <li><strong>Account Data:</strong> Until you delete your account</li>
                    <li><strong>Content:</strong> Until you delete the specific content</li>
                    <li><strong>Log Data:</strong> Typically 90 days</li>
                    <li><strong>Support Data:</strong> 3 years after case closure</li>
                  </ul>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Ottopen operates globally, and your information may be transferred to and processed in countries
                ...
                <section className="mb-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Ottopen is not intended for users under 13 years of age. We do not knowingly collect personal
