        ...
        <div className="flex items-start space-x-3 sm:space-x-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="prose prose-sm max-w-none mb-3 sm:mb-4">
              <p className="text-foreground text-sm sm:text-base leading-relaxed whitespace-pre-line break-words">{content}</p>
            </div>
            ...
            <div className="flex items-center justify-between sm:justify-start sm:space-x-6 text-sm text-muted-foreground">
              ...
              >
                <Repeat2 className={`h-3 w-3 sm:h-4 sm:w-4 mr-1 ${reshared ? 'text-green-500' : ''}`} />
